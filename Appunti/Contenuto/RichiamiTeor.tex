...
Parto dalla $w_s$, scrivo $\Phi$ e $\psi$ nei diversi punti di funzionamento della macchina in funzione di $w_s$. 
\begin{equation}
...
\begin{figure}[h!]
\centering
  \includegraphics[width=.7\textwidth]{fig/ComprMach.pdf}
\caption{Curve adimensionali di funzionamento di una famiglia di compressori, per un fluido assegnato, a diversi numeri di Mach periferici. Sono definiti $Ma = \frac{w D}{a_{01}}$, $Mu = \frac{w \frac{D}{2}}{a}$}
\label{fig:ComprMach}
\end{figure}
...
\begin{equation}
\frac{n}{\sqrt{T_{01}}}=\frac{n_c}{\sqrt{T_{01s}}} \; n_c = n \sqrt{\frac{T_{01s}}{T_{01}}}
\end{equation}
...
\begin{multicols}{3}
\begin{align*}
M_{01}=\frac{w D}{a_{01}}= \frac{w D}{\sqrt{k R T_{01}}}
\end{align*}
\begin{align*}
p = \rho_i RT
\end{align*}
