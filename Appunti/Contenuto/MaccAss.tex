...
Si consideri l'elemento di fluido $dz - d\theta - dr$, figura \ref{fig:concio}, su cui agiscono le forze di pressione. Si calcoli l'equilibrio delle forze:
\begin{align*}
...
\begin{align*}
\frac{p}{p_i} = \Bigg(\frac{h}{h_i}\Bigg)^{\frac{k}{k-1}}
\end{align*}
\begin{figure}
\centering
