...
\end{minipage}
\end{figure}
Posso rappresentare queste trasformazioni sul piano $h-s$ con una trasformazione non isoentropica. Nel caso di ugelli per $Ma < 0.3$ posso scrivermi tutte le grandezze: 
\begin{align*}
